...
//
var ivan = new Deputy_1.Deputy('ivan', 33, 'male', 10, 100);
var petro = new Deputy_1.Deputy('petro', 23, 'male', 60, 1000);
var vasya = new Deputy_1.Deputy('vasya', 45, 'male', 33, 580);
var mykola = new Deputy_1.Deputy('mykola', 23, 'male', 12, 1100);
var viktor = new Deputy_1.Deputy('viktor', 45, 'male', 56, 500);
var olya = new Deputy_1.Deputy('olya', 25, 'female', 10, 1000);
var taras = new Deputy_1.Deputy('taras', 60, 'male', 60, 1000);
var igor = new Deputy_1.Deputy('igor', 55, 'male', 33, 50);
var vova = new Deputy_1.Deputy('vova', 27, 'male', 88, 1100);
var olena = new Deputy_1.Deputy('olena', 32, 'female', 3, 500);
var vika = new Deputy_1.Deputy('vika', 33, 'female', 1, 500);
var maria = new Deputy_1.Deputy('maria', 45, 'female', 2, 500);
//
...
var kryvda = new Party_1.Party('Kryvda', maria, [olena, vika, maria]);
